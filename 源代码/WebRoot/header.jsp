    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Manager/frontlist">管理员查询</a></li><!-- 
                <li><a href="<%=basePath %>ProjectType/frontlist">项目性质</a></li> -->
                <li><a href="<%=basePath %>Project/frontlist">项目查询</a></li>
                <li><a href="<%=basePath %>Thesis/frontlist">论文查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Project/project_frontUserAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;申报科研项目</a></li>
                        <li><a href="<%=basePath %>Project/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我申报的项目</a></li>
                        <li><a href="<%=basePath %>Thesis/thesis_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;论文提交</a></li>
                        <li><a href="<%=basePath %>Thesis/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我提交的论文</a></li>
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp?user_name=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
