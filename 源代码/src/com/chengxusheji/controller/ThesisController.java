...
public class ThesisController extends BaseController {
	...
	public void userAdd(Thesis thesis, BindingResult br,
	...
	public String userFrontlist(String author,String teacher,String publishDate,@ModelAttribute("userObj") UserInfo userObj,String xkml,String name,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (author == null) author = "";
		if (teacher == null) teacher = "";
		if (publishDate == null) publishDate = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "Thesis/thesis_frontUserquery_result"; 
	}
