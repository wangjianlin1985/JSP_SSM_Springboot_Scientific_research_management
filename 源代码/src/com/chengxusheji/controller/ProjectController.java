...
public class ProjectController extends BaseController {
	...
	/*用户前台客户端ajax方式提交添加项目信息*/
	@RequestMapping(value = "/userAdd", method = RequestMethod.POST)
	public void userAdd(Project project, BindingResult br,
	...
	public String userFrontlist(@ModelAttribute("projectTypeObj") ProjectType projectTypeObj,String projectName,String mainPerson,String startDate,@ModelAttribute("userObj") UserInfo userObj,String shzt,String shr,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (projectName == null) projectName = "";
		if (mainPerson == null) mainPerson = "";
		if (startDate == null) startDate = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "Project/project_frontUserquery_result"; 
	}
	...
	/*项目管理员ajax方式更新项目信息*/
	@RequestMapping(value = "/{projectId}/managerUpdate", method = RequestMethod.POST)
	public void managerUpdate(Project project, BindingResult br,
			Model model, HttpServletRequest request,HttpServletResponse response,HttpSession session) throws Exception {
		String message = "";
    	boolean success = false;
		...
		try {
			project.setShr(session.getAttribute("manager").toString()); 
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			project.setShsj(sdf.format(new java.util.Date())); 
